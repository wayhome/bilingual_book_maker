...
{target_lang}:"""
    ...
    translation = get_completion(client, translation_prompt, system_message=system_message, model=model)
...
Output only the suggestions and nothing else."""
    ...
    reflection = get_completion(client, reflection_prompt, system_message=system_message, model=model)
    return reflection
...
Output only the new translation and nothing else."""
    ...
    translation_2 = get_completion(client, prompt, system_message, model=model)
...
def one_chunk_translate_text(
    ...
    translation_1 = one_chunk_initial_translation(
        client, source_lang, target_lang, source_text, model
    )

    reflection = one_chunk_reflect_on_translation(
        client, source_lang, target_lang, source_text, translation_1, country, model
    )
    translation_2 = one_chunk_improve_translation(
        client, source_lang, target_lang, source_text, translation_1, reflection, model
    )
...
"""
    ...
    for i in range(len(source_text_chunks)):
        ...
        translation = get_completion(client, prompt, system_message=system_message, model=model)
...
Output only the suggestions and nothing else."""
    ...
    for i in range(len(source_text_chunks)):
        ...
        reflection = get_completion(client, prompt, system_message=system_message, model=model)
...
def multichunk_translation(
    ...
    translation_1_chunks = multichunk_initial_translation(
        client, source_lang, target_lang, source_text_chunks, model
    )

    reflection_chunks = multichunk_reflect_on_translation(
        client, source_lang, target_lang, source_text_chunks, translation_1_chunks, country, model
    )

    translation_2_chunks = multichunk_improve_translation(
        client, source_lang, target_lang, source_text_chunks, translation_1_chunks, reflection_chunks, model
    )
...
def agent_translate(
    ...
    """Translate the source_text from source_lang to target_lang using the agent-based approach."""
    ...
    if num_tokens_in_text < max_tokens:
        ...
        final_translation = one_chunk_translate_text(
            client, source_lang, target_lang, source_text, country, model=model
        )
        ...
        translation_2_chunks = multichunk_translation(
            client, source_lang, target_lang, source_text_chunks, country, model=model
        )
